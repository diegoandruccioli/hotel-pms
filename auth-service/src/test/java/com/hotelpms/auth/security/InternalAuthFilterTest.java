...
class InternalAuthFilterTest {
    ...
    private static String filterHmacMaterial() {
        return "unit-test-internal-auth-filter-auth-service";
    }
    ...
    class ProtectedPathScoping {
        ...
        @Test
        @DisplayName("/api/v1/auth/users is enforced — missing headers still reject")
        void shouldEnforceOnProtectedPath() throws IOException, ServletException {
            final MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    class HmacCheck {
        ...
        @Test
        @DisplayName("Valid headers on the protected path → passes chain and populates SecurityContext")
