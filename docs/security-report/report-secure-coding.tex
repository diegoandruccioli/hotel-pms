...
\begin{insecurebox}{Baseline --- HMAC su username:role soltanto}{java}
...
\begin{securebox}{Fix --- HMAC su username:role:hotelId}{java}
...
\vspace{0.5em}
\begin{insecurebox}{Codice vulnerabile --- fb-service InternalAuthFilter (presenza separata)}
...
\vspace{0.5em}
\begin{securebox}{Codice sicuro --- fb-service InternalAuthFilter (singolo if canonico)}
\begin{lstlisting}[language=Java]
...
\vspace{0.5em}
\begin{insecurebox}{Situazione precedente --- log su stdout, nessuna aggregazione}
...
\vspace{0.5em}
\begin{securebox}{Livello 1 --- Loki e Grafana in docker-compose (observability-network)}
...
\vspace{0.5em}
\begin{securebox}{Livello 2 --- logback-spring.xml con LokiAppender (auth-service)}
...
\vspace{0.5em}
\begin{securebox}{Livello 3 --- Query LogQL nella dashboard Grafana}
...
\begin{insecurebox}{Netty 4.1.130 — request smuggling e HTTP/2 DoS (gateway ingress)}
...
\begin{insecurebox}{Spring Cloud Gateway 4.2.0 --- header forwarding e EL injection}
...
\begin{securebox}{Netty 4.1.132.Final via Spring Boot BOM property override}
...
\begin{securebox}{Spring Cloud Gateway 4.2.6 via dependencyManagement override}
...
\begin{securebox}{Impatto sulla postura di sicurezza}
...
\begin{insecurebox}{CVE-2025-48976 — Apache Commons FileUpload DoS}
...
\begin{insecurebox}{CVE-2024-47554 — Apache Commons IO XmlStreamReader DoS}
...
\begin{securebox}{dependencyManagement.dependencies su tutti gli 8 microservizi}
...
\begin{insecurebox}{CVE-2026-22739 — Path Traversal via Profile Parameter}
...
\begin{securebox}{Mitigazioni compensative}
\begin{itemize}
