...
\paragraph{Riferimento} Commit: \commitref{placeholder}{fix(security): T-AUTH-04 --- refresh token rotation + Redis blacklist}
...
\paragraph{Riferimento} Commit: \commitref{PLACEHOLDER\_T\_GW\_05}{fix(security): T-GW-05 --- CSRF protection via Double Submit Cookie}
