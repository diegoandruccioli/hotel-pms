...
\paragraph{Riferimento} Commit: \commitref{TO\_FILL}{fix(security): T-GW-03 --- add SecurityHeadersFilter for HTTP security headers}
...
\paragraph{Riferimento} Commit: \commitref{TO\_FILL}{fix(security): T-FE-04 --- add CSP via nginx.conf and make API base URL relative}
