package com.hotelpms.guest.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.hotelpms.guest", importOptions = ImportOption.DoNotIncludeTests.class)
final class TenantIsolationArchTest {
    ...
    private static final Set<String> TENANT_ROOT_REPOSITORIES = Set.of(
            "com.hotelpms.guest.repository.GuestRepository",
            "com.hotelpms.guest.repository.GuestPrivacySettingsRepository");
