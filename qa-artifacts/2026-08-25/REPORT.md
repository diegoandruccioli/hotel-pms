...
| 3 — Sweep elementi per area | 🔄 in corso | Ospiti ✅, Prenotazioni ✅, Camere/Tipologie ✅ (CRUD completo), Pulizie ✅ (+ 1 difetto 🟡), Fatturazione (parziale via MCP), Preventivi (parziale via MCP) |
| 4 — Dati negativi | 🔄 in corso | HotelProfile (VAT/CAP/logoUrl) ✅ 8/8 verdi |
| 5 — Matrice portali | 🔄 in corso | D1 Alloggiati ✅ (1 difetto 🟡 risolto, empty-report D1.10 verificato) · D3 City tax ✅ (1 difetto 🟢 documentato, validazione client-side + overlap verificati) · D2 FatturaPA ✅ (identità completa/incompleta, switch RICEVUTA↔FATTURA — nessun nuovo difetto) · D4 email non ancora coperto |
| 6 — Interruzioni | ⏳ non iniziato | infrastruttura (`faultInjector.ts`) pronta |
